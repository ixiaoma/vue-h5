<template>
    <div class="order-page box-style">
        <div v-if='systemUser == "courier"' class="search">
        ...
        <mt-loadmore class="order-list" :top-method="loadTop" ref="loadmore">
            <ul v-infinite-scroll="loadMore"
                ...
                <li class="order-li border-style" v-for="item in listData" :key='item'>
                    <div v-if='systemUser == "courier"' class="courier-order" @click="toDetail(item)">
                        <img src="#" alt="图片">
                        <div class="order-info">
                            ...
                            <p>北京→天津</p>
                            <p>
                                <span class="little-font">丁小凡  133-3344-5566</span>
                            </p>
                            <p class="info-btm little-font red-font">
                                状态：已签收
                            </p>
                        </div>
                    </div>
